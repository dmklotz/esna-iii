...
as the Potter.  
Overseer of the Field[^fn-328-3]    
...
[^fn-328-3]: ![](./images/328_A2.png){width=8%} - For this reading, see @recklinghausen-field (non vidi).  
...
[^fn-328-5]: ![](./images/328_B3.png){width=20%}![](./images/328_B4.png){width=10%} - *LGG* IV, 596b, cited this unique epithet, but only translated the first half. However, the same epithet occurs twice elsewhere to describe Shemanefer: [Esna 324, 13]:  ![](./images/324_13A.png){width=18%}. Although partially damaged there, in the same scene the king is described as the successor of the same god: [Esna 324, 5]: ![](./images/324_5A.png){width=22%}. Apparently Shemanefer, son of Neith, was considered even "more ancient" than Horus. Compare a similar royal epithet in [Esna 334], 6.
[^fn-328-6]: ![](./images/328_B5.png){width=11%} - Following the suggestion of *LGG* IV, 86b-c to change the harpoon sign to a stick, and read *r'-(ʿ)-ḫt*, "combat." Similar spellings (with a stick) can be found in [Esna 337], B; [Esna 350], 16. However, since Neith was the goddess of archery, one might alternatively suggest reading *r'-pḏ.t*, "archery (*Wb.* II, 397, 9)